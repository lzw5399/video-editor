...
require_fixed "apps/desktop-electron/tests/interaction-preview-inspector.spec.ts" "preview text rotate handle changes native compositor rotation evidence"
require_fixed "apps/desktop-electron/tests/interaction-preview-inspector.spec.ts" "visualRotationDegrees"
require_fixed "apps/desktop-electron/tests/interaction-preview-inspector.spec.ts" "renderGraphGpuComposited"
require_fixed "apps/desktop-electron/tests/interaction-preview-inspector.spec.ts" "rotationDegrees"
require_fixed "apps/desktop-electron/tests/interaction-preview-inspector.spec.ts" "rotationDeltaDegrees"
