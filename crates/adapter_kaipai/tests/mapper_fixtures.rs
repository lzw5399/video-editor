    ...
    let items = match case.family {
        ...
        "pip-overlay" => vec![
            ...
            item(
                ...
                "Main video source and speed-adjusted target timeranges map to canonical integer microseconds.",
                Some(
                    "durationMsWithSpeed=5000 maps to a 5s target range while preserving the 5s source range.",
                ),
                case.family,
                "formula.videoClipList[0]",
            ),
        ...
        "native-effect" => vec![
            ...
            item(
                ...
                "Main video source and speed-adjusted target timeranges map to canonical integer microseconds.",
                Some(
                    "durationMsWithSpeed=4000 maps to a 4s target range while preserving the 4s source range.",
                ),
                case.family,
                "formula.videoClipList[0]",
            ),
