...
use draft_model::{
    ...
    SaveProjectBundleCommandPayload, SaveProjectBundleResponse, SegmentAudio,
    SegmentBackgroundFilling, SegmentBlendMode, SegmentCrop, SegmentFitMode,
    ...
    SetTrackMuteCommandPayload, SetTrackVisibilityCommandPayload, SnappingSettings,
    SourceTimerange, SplitSegmentCommandPayload, StartExportCommandPayload, TargetTimerange,
...
fn schema_exports_generated_contract_artifacts_from_rust() {
    ...
    let command_envelope_ts = ts_contract_with_prelude(
        ...
        &[
            ...
            export_decl::<OpenProjectBundleCommandPayload>(),
            export_decl::<SaveProjectBundleCommandPayload>(),
    ...
    let command_result_ts = ts_contract_with_prelude(
        ...
        &[
            ...
            export_decl::<OpenProjectBundleResponse>(),
            export_decl::<SaveProjectBundleResponse>(),
