...
- [x] 15.1-05-PLAN.md - Add Rust-owned multitrack commands and minimal timeline controls
...
- [x] 15.2-03B-PLAN.md - Import native decoded textures into the WGPU compositor
...
- [x] 15.2-04A-PLAN.md - Add Rust-owned realtime playback scheduler for desktop compositor presentation (blocked: WGPU surface texture acquire reports surface is occluded)
...
- [x] 15.2-04C-PLAN.md - Attempt macOS/Electron native WGPU drawable lifecycle repair (blocked: AppKit occlusion visible remains false)

**Wave 10** *(blocked on Wave 9 completion)*

- [x] 15.2-04D-PLAN.md - Close macOS foreground activation and in-window native WGPU surface presentation (blocked: automated Electron/packaged app remains AppKit inactive/frontmost=false, so WGPU surface acquire still reports occluded)

**Wave 11** *(blocked on Wave 10 completion)*

- [x] 15.2-04E-PLAN.md - Launch foreground packaged product E2E through CDP and prove real visible GPU playback without fallback (blocked: packaged/CDP and child-window native WGPU presenter still report AppKit occlusion-invisible)
...
Phase 15.3 is complete. Phase 16 is ready to plan.
...
- [x] 15.3-04-PLAN.md - Productionize preview monitor and transport controls
- [x] 15.3-05-PLAN.md - Focus the right inspector and draft parameter modal
- [x] 15.3-06-PLAN.md - Convert timeline toolbar/interactions from debug inputs to editor controls
- [x] 15.3-07-PLAN.md - Add icon discipline, reference manifest, source guards, and layout regression
- [x] 15.3-08-PLAN.md - Add aggregate Phase 15.3 verification and closeout
...
- [x] 17-01-PLAN.md - Create Wave 0 provider-neutral report contracts and source guards
- [x] 17-02-PLAN.md - Localize offline template resources into `.veproj/resources`
- [x] 17-04-PLAN.md - Add current-main offline Kaipai bundle contract and sanitized fixtures
- [x] 17-07-PLAN.md - Close generic static rotation export parity
...
- [x] 17-05-PLAN.md - Add Kaipai mapper fixture and AdaptationReport snapshot setup

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 17-10-PLAN.md - Implement Kaipai fixture mapper to DraftImportPlan and AdaptationReport

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 17-06-PLAN.md - Apply imported plans atomically through project-session API

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 17-08-PLAN.md - Prove imported fixtures through preview/export and aggregate gates
...
- [x] 17.1-04-PLAN.md - Wire timeline, playhead scrub, and keyframe interactions
...
- [x] 18-03-PLAN.md — Thin `bindings_node` into a desktop adapter over `editor_runtime`
- [x] 18-04-PLAN.md — Add portable `bindings_c` ABI, generated header, and handle smoke tests
- [x] 18-05-PLAN.md — Add Electron-free `server_runtime` export/progress/cancel path
...
- [x] 19-01-PLAN.md — Add Phase 19 guards, package scripts, RED tests, and schema-push detection note

**Wave 1** *(blocked on Wave 0 completion)*

- [x] 19-02-PLAN.md — Define typed capability registry and effect/transition/retime contracts

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 19-03-PLAN.md — Implement Rust retiming commands and engine source mapping

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 19-04-PLAN.md — Propagate retiming through render graph, preview, compiler, and parity fixtures

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 19-05-PLAN.md — Represent retiming in audio_engine and testkit audio parity
- [x] 19-06-PLAN.md — Implement first-class transition model and undoable commands

**Wave 5** *(blocked on Wave 4 transition model completion)*

- [x] 19-07-PLAN.md — Propagate transitions through graph, preview diagnostics, compiler, and guards
...
- [x] 19-09-PLAN.md — Propagate first-party effects through graph, GPU preview, compiler, and guards

**Wave 8** *(blocked on Wave 7 completion)*

- [x] 19-10-PLAN.md — Implement mask and blend model/command semantics

**Wave 9** *(blocked on Wave 8 completion)*

- [x] 19-11-PLAN.md — Propagate masks/blends through graph, GPU preview, compiler diagnostics, and guards

**Wave 10** *(blocked on Wave 9 completion and 19-05 audio retiming completion)*

- [x] 19-12-PLAN.md — Expose Rust project-session command and interaction surfaces

**Wave 11** *(blocked on Wave 10 completion)*

- [x] 19-13-PLAN.md — Integrate capability-backed desktop UI controls and product E2E

**Wave 12** *(blocked on Wave 11 completion)*

- [x] 19-14-PLAN.md — Add Kaipai/Jianying-like template fidelity fixtures and report mapping
