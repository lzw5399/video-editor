...
- [x] 03.1-01-PLAN.md - Create adapter crate, formula bundle contracts, and generated schema/TypeScript drift gates
...
- [x] 03.1-03-PLAN.md - Create compatibility report schema, snapshots, and native-effect classification

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 03.1-04-PLAN.md - Create resource localizer boundary and local path-safety tests
