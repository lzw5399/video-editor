...
| 20-W1-pressure | TBD | 1 | LONG11-02 | T20-05 | Export/probe/artifact/cache pressure does not block scrub, inspector edit, preview delivery, commit, or cancel | Playwright stress | `pnpm --filter @video-editor/desktop exec playwright test tests/product-long-timeline-uat.spec.ts -g pressure --reporter=line --workers=1` | no | pending |
| 20-W2-aggregate | TBD | 2 | UAT11-01, UAT11-02, LONG11-01, LONG11-02, GATE11-01 | T20-06 | Phase aggregate fails fallback/source-only success and proves Rust, contract, product, and export gates | Aggregate | `pnpm run test:phase20` | no | pending |
