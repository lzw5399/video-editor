...
| 14-02-01 | 02 | 1 | ASSET-01 | T-14-03 | Materials, fonts, effects, proxies, thumbnails, and waveforms receive stable resource IDs and project-relative refs | Rust unit/integration | `cargo test -p artifact_store resource_index -- --nocapture` | W0 | pending |
| 14-03-01 | 03 | 2 | ASSET-03 | T-14-04 | Replace/relink/rename/delete invalidates only dependency-matched artifact rows unless overflow/unknown requires full-draft fallback | Rust integration | `cargo test -p artifact_store invalidation -- --nocapture` | W0 | pending |
| 14-04-01 | 04 | 2 | ASSET-04 | T-14-05 | Derived generation stores chunk/job status and cancellation/resume state without blocking preview service contracts | Rust integration | `cargo test -p artifact_store artifact_jobs -- --nocapture` | W0 | pending |
| 14-05-01 | 05 | 3 | ASSET-05 | T-14-06 | GC/quota/sync manifest preserves live blobs and reports only project-relative/fingerprinted artifacts | Rust integration | `cargo test -p artifact_store gc_quota_manifest -- --nocapture` | W0 | pending |
| 14-06-01 | 06 | 3 | ASSET-01, ASSET-02, ASSET-04 | T-14-07 | Binding/UI contracts expose status/progress/actions only; renderer does not compute artifact internals | Rust + pnpm + Playwright | `pnpm run test:phase14 && pnpm run test:contracts` | W0 | pending |
