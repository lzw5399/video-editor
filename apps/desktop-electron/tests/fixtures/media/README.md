...
- `p0-av-tone-testsrc.mp4`: 3s, 320x180, 30 fps, MPEG-4 video generated from FFmpeg `testsrc2` with a 660 Hz AAC mono audio stream; used for embedded video-audio playback journeys.
